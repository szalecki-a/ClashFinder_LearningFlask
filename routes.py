...
def user(username):
	...
	if request.method == 'POST' and form.validate():
		new_profile = Profile(nickname = form.nickname.data, server=form.server.data, division=form.division.data, best_position=form.pref_role.data, alternative_position=form.alternative_role.data, user_id=current_user.id)
