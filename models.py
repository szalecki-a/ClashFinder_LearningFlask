...
class User(UserMixin, db.Model):
  ...
  profiles = db.relationship('Profile', backref='Player', lazy='dynamic', cascade = "all, delete, delete-orphan") #powiązanie z kontem uzytkownika
  reports = db.relationship('ReportPlayer', backref='Report', lazy='dynamic', cascade = "all, delete, delete-orphan") #powiązanie z kontem uzytkownika
